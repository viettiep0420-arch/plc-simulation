export const BG_DIAGRAM = "#FFFFFFF";
...
export const BG_WIRING = "#FFF5E6"; // Màu cam nhạt cho tab Wiring
export const ELEMENT = "#3D3D3D";
export const ELEMENT_NOT_CFG = "#FF0000";
export const OUT_ON = "#13A465";
...
export const DROP_HIGHLIGHT = "#EDB51C";

export const BLOCK_PARAM_BG = 'rgba(255, 255, 255, 0.7)';
